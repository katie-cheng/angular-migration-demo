...
describe('ProfileSettingsListComponent', () => {
  ...
  let service: jasmine.SpyObj<ProfileSettingsService>;

  beforeEach(async () => {
    service = jasmine.createSpyObj<ProfileSettingsService>('ProfileSettingsService', ['list', 'get', 'save', 'remove', 'first', 'count']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: ProfileSettingsService, useValue: service }, provideHttpClient(withInterceptorsFromDi()), provideHttpClientTesting()]
    }).compileComponents();
