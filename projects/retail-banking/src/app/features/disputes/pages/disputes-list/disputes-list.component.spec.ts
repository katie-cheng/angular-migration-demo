...
describe('DisputesListComponent', () => {
  ...
  let service: jasmine.SpyObj<DisputesService>;

  beforeEach(async () => {
    service = jasmine.createSpyObj<DisputesService>('DisputesService', ['list', 'get', 'save', 'remove', 'first', 'count']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: DisputesService, useValue: service }, provideHttpClient(withInterceptorsFromDi()), provideHttpClientTesting()]
    }).compileComponents();
