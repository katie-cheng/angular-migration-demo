...
describe('CardsListComponent', () => {
  ...
  let service: jasmine.SpyObj<CardsService>;

  beforeEach(async () => {
    service = jasmine.createSpyObj<CardsService>('CardsService', ['list', 'get', 'save', 'remove', 'first', 'count']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: CardsService, useValue: service }, provideHttpClient(withInterceptorsFromDi()), provideHttpClientTesting()]
    }).compileComponents();
