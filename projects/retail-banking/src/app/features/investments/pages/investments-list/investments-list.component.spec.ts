...
describe('InvestmentsListComponent', () => {
  ...
  let service: jasmine.SpyObj<InvestmentsService>;

  beforeEach(async () => {
    service = jasmine.createSpyObj<InvestmentsService>('InvestmentsService', ['list', 'get', 'save', 'remove', 'first', 'count']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [{ provide: InvestmentsService, useValue: service }, provideHttpClient(withInterceptorsFromDi()), provideHttpClientTesting()]
    }).compileComponents();
