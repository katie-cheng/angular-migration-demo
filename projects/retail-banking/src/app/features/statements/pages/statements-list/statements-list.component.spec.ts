...
describe('StatementsListComponent', () => {
  ...
  let service: jasmine.SpyObj<StatementsService>;

  beforeEach(async () => {
    service = jasmine.createSpyObj<StatementsService>('StatementsService', ['list', 'get', 'save', 'remove', 'first', 'count']);
    ...
    providers: [{ provide: StatementsService, useValue: service }, provideHttpClient(withInterceptorsFromDi()), provideHttpClientTesting()]
}).compileComponents();
